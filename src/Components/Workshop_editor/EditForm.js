...
class EditForm extends Component {
    ...
    submitclick = () => {
        ...
        if(errorCheck) {
            ...
            axios.put(`${process.env.REACT_APP_URL}/workshops/${this.props.workshopid}/update`, sendData ).then(res => {
                console.log(res);
                console.log(res.data);
            })
            alert("Submitted")
            //console.log(this.state.content)
            axios.get(`${process.env.REACT_APP_URL}/tags/deletebyid/${this.props.workshopid}`).then(res => {
               console.log(res)
            })
    ...
    componentDidMount() {
        ...
        axios.get(`${process.env.REACT_APP_URL}/workshops/${this.props.workshopid}`).then(res => { 
        ...
        axios.get(`${process.env.REACT_APP_URL}/tags/findbyid/${this.props.workshopid}`).then(res => {
